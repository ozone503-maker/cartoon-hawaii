...
export const TELESCOPES = [
  ...
  { id: "cfht", name: "CFHT", lat: 19.825252, lon: -155.468876, kind: "white" as const, r: 0.16 },
  { id: "irtf", name: "NASA IRTF", lat: 19.826218, lon: -155.471999, kind: "white" as const, r: 0.13 },
  { id: "ukirt", name: "UKIRT", lat: 19.822431, lon: -155.470327, kind: "ukirt" as const },
  { id: "uh22", name: "UH 2.2 m", lat: 19.822991, lon: -155.469434, kind: "white" as const, r: 0.11 },
  { id: "uh06", name: "UH 0.6 m", lat: 19.821614, lon: -155.470963, kind: "white" as const, r: 0.08 },
